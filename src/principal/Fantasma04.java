...
public class Fantasma04 extends Elemento implements Runnable{
	...
	public void desenha(Graphics2D g2d) {
		Image img = Toolkit.getDefaultToolkit().getImage("imagens/vermelho.png");
	...
	public void setPesoX(int peso){
		Fantasma04.pesoX = peso;
	}
	
	public int getPesoX(){
		return Fantasma04.pesoX;
	}
	
	public void setPesoY(int peso){
		Fantasma04.pesoY = (peso);
	}
	
	public int getPesoY(){
		return Fantasma04.pesoY;
	}
