...
public class Fantasma01 extends Elemento implements Runnable{
	...
	private static final int TAM_X = 29;
	private static final int TAM_Y = 27;
	
	public Fantasma01(Color cor) {
	...
	public void desenha(Graphics2D g2d) {
		Image img = Toolkit.getDefaultToolkit().getImage("imagens/azul.png");
	...
	public void setPesoX(int peso){
		Fantasma01.pesoX = peso;
	}
	
	public int getPesoX(){
		return Fantasma01.pesoX;
	}
	
	public void setPesoY(int peso){
		Fantasma01.pesoY = (peso);
	}
	
	public int getPesoY(){
		return Fantasma01.pesoY;
	}
