...
public class Fantasma03 extends Elemento implements Runnable{
	...
	public void desenha(Graphics2D g2d) {
		Image img = Toolkit.getDefaultToolkit().getImage("imagens/rosa.png");
	...
	public void setPesoX(int peso){
		Fantasma03.pesoX = peso;
	}
	
	public int getPesoX(){
		return Fantasma03.pesoX;
	}
	
	public void setPesoY(int peso){
		Fantasma03.pesoY = (peso);
	}
	
	public int getPesoY(){
		return Fantasma03.pesoY;
	}
